...
export default function Widget({
  ...
  if (label === 'Solar Radiation') {
    ...
    return (
      <StyledWrapper>
      <div className="card bg-lightBg text-lightText dark:bg-darkBg dark:text-darkText shadow-md rounded-2xl p-6 flex flex-col items-center justify-center cursor-pointer hover:shadow-lg transition-transform duration-300 rounded-2xl">
        ...
        <div className="text-sm text-gray-500 dark:text-gray-300">{value} W/m²</div>
      </div>
      </StyledWrapper>
    );
  }
  ...
  if (label === 'Wind Speed') {
    const angle = ((value - min) / (max - min)) * 180; // 0° to 180°
    return (
      <StyledWrapper>
      <div className="card bg-lightBg text-lightText dark:bg-darkBg dark:text-darkText shadow-md rounded-2xl p-6 flex flex-col items-center cursor-pointer hover:shadow-lg transition-transform duration-300">
        <div className="relative w-32 h-16 mb-3">
          ...
          <div
            ...
            style={{ transform: `rotate(${angle}deg) translateX(-50%)`, transformOrigin: 'bottom center', transition: 'transform 0.5s ease' }}
          />
        </div>
    ...
    return (
      ...
      <div className="card bg-lightBg text-lightText dark:bg-darkBg dark:text-darkText shadow-md rounded-2xl p-6 flex flex-col items-center cursor-pointer hover:shadow-lg transition-transform duration-300">
        <div className="relative w-20 h-20 mb-4">
          <div className="absolute inset-0 rounded-full border border-gray-400 dark:border-gray-300" />
          <div
            className="absolute top-1/2 left-1/2 w-1 h-10 bg-red-500 dark:bg-darkcontrast origin-bottom"
  ...
  if (label === 'Relative Humidity') {
    ...
    return (
      ...
      <div className="card bg-lightBg text-lightText dark:bg-darkBg dark:text-darkText shadow-md rounded-2xl p-6 flex flex-col items-center cursor-pointer hover:shadow-lg transition-transform duration-300">
        ...
        <div className="text-md font-medium text-gray-800 dark:text-white mb-1">{label}</div>
        <div className="text-4xl font-bold text-gray-900 dark:text-white mb-2">{value}%</div>
        <div className="w-full h-3 bg-gray-200 dark:bg-slate-600 rounded-full overflow-hidden mb-2">
          <div
  ...
  return (
    <StyledWrapper>
    <div className="card bg-lightBg text-lightText dark:darkmain dark:text-darkText shadow-md rounded-2xl p-5 w-full cursor-pointer hover:shadow-lg transition-transform duration-300">
